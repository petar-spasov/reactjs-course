...
const FormDialog = (props) => (
    <Dialog open={props.dialogState.openDialog}
            onClose={() => props.toggleAddDialog(false)}
...
FormDialog.propTypes = {
    ...
    todoTitleInputHandler: PropTypes.func.isRequired,
    todoDescriptionInputHandler: PropTypes.func.isRequired,
    todoCompletedCheckboxHandler: PropTypes.func.isRequired,
    persistTodo: PropTypes.func.isRequired,
};
